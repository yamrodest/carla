        ...
        for segment in self._topology:
            ...
            for waypoint in segment['path']:
                if not segment['entry'].is_junction:
                    ...
                    if waypoint.right_lane_marking is not None and waypoint.right_lane_marking.lane_change & carla.LaneChange.Right and not right_found:
                        ...
                        if next_waypoint is not None and next_waypoint.lane_type == carla.LaneType.Driving and waypoint.road_id == next_waypoint.road_id:
                            ...
                            if next_segment is not None:
                                ...
                                right_found = True
                    if waypoint.left_lane_marking is not None and waypoint.left_lane_marking.lane_change & carla.LaneChange.Left and not left_found:
